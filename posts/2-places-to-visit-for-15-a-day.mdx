  ...
  cards={[
    {
      ...
      expenses: [
        { category: 'Accommodation', cost: 5, color: '#4caf50' },
        { category: 'Meals', cost: 4, color: '#2196f3' },
        { category: 'Local Transport', cost: 3, color: '#ff9800' },
        { category: 'Activities', cost: 3, color: '#9c27b0' },
        { category: 'Extras', cost: 0, color: '#f44336' },
      ],
    },
    {
      title: 'Yolo Tourist',
      expenses: [
        { category: 'Hotel', cost: 10, color: '#4caf50' },
        { category: 'Fine Dining', cost: 8, color: '#2196f3' },
        { category: 'Private Tours', cost: 5, color: '#ff9800' },
        { category: 'Transport', cost: 6, color: '#9c27b0' },
        { category: 'Shopping', cost: 0, color: '#f44336' },
      ],
    },
    {
      title: 'Digital Nomad',
      expenses: [
        { category: 'Co-living', cost: 7, color: '#4caf50' },
        { category: 'Cafés & Meals', cost: 4, color: '#2196f3' },
        { category: 'Co-working', cost: 2, color: '#ff9800' },
        { category: 'Transit', cost: 1, color: '#9c27b0' },
        { category: 'Leisure', cost: 1, color: '#f44336' },
      ],
    },
  ]}
/>
